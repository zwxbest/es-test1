...
GRANT ALL ON `xunwu`.* TO 'zwxbest';

DROP DATABASE IF EXISTS `xunwu_test`;
CREATE DATABASE `xunwu_test`;

GRANT ALL ON `xunwu_test`.* TO 'zwxbest';
...
CREATE TABLE `house` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'house唯一标识1',
  `title` varchar(32) NOT NULL,
  `price` int(11) unsigned NOT NULL default 0 COMMENT '价格',
  `area` int(11) unsigned NOT NULL default 0 COMMENT '面积',
  `room` int(11) unsigned NOT NULL default 0 COMMENT '卧室数量',
  `floor` int(11) unsigned NOT NULL default 0 COMMENT '楼层',
  `total_floor` int(11) unsigned NOT NULL default 0 COMMENT '总楼层',
  `watch_times` int(11) unsigned DEFAULT '0' COMMENT '被看次数',
  `build_year` int(4) NOT NULL default 0 COMMENT '建立年限',
  ...
  `city_en_name` varchar(32) NOT NULL default '' COMMENT '城市标记缩写 如 北京bj',
  `region_en_name` varchar(255) NOT NULL default '' COMMENT '地区英文简写 如昌平区 cpq',
  `cover` varchar(32) DEFAULT NULL COMMENT '封面',
  `direction` int(11) NOT NULL default 0 COMMENT '房屋朝向',
  `distance_to_subway` int(11) NOT NULL DEFAULT '-1' COMMENT '距地铁距离 默认-1 附近无地铁',
  `parlour` int(11) NOT NULL DEFAULT '0' COMMENT '客厅数量',
  `district` varchar(32) NOT NULL default '' COMMENT '所在小区',
...
CREATE TABLE `house_detail` (
  ...
  `rent_way` int(2) NOT NULL default 0 COMMENT '租赁方式',
  `address` varchar(32) NOT NULL default '' COMMENT '详细地址 ',
  ...
  `house_id` int(11) NOT NULL default 0 COMMENT '对应house的id',
  PRIMARY KEY (`id`),
...
CREATE TABLE `house_picture` (
  ...
  `house_id` int(11) NOT NULL default 0 COMMENT '所属房屋id',
  `cdn_prefix` varchar(255) NOT NULL default '' COMMENT '图片路径',
  `width` int(11) DEFAULT NULL COMMENT '宽',
  `height` int(11) DEFAULT NULL COMMENT '高',
  `location` varchar(32) DEFAULT NULL COMMENT '所属房屋位置',
  `path` varchar(255) NOT NULL default '' COMMENT '文件名',
  PRIMARY KEY (`id`)
...
CREATE TABLE `house_subscribe` (
  ...
  `admin_id` int(11) NOT NULL default 0 COMMENT '房源发布者id',
  PRIMARY KEY (`id`),
...
CREATE TABLE `role` (
  ...
  `name` varchar(32) NOT NULL default '' COMMENT '用户角色名',
  PRIMARY KEY (`id`),
...
CREATE TABLE `subway` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(32) NOT NULL default '' COMMENT '线路名',
  `city_en_name` varchar(32) NOT NULL default '' COMMENT '所属城市英文名缩写',
  PRIMARY KEY (`id`),
...
CREATE TABLE `subway_station` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `subway_id` int(11) NOT NULL default 0 COMMENT '所属地铁线id',
...
CREATE TABLE `support_address` (
  ...
  `en_name` varchar(32) NOT NULL default '' COMMENT '行政单位英文名缩写',
  `cn_name` varchar(32) NOT NULL default '' COMMENT '行政单位中文名',
  `level` varchar(16) NOT NULL default '' COMMENT '行政级别 市-city 地区-region',
...
CREATE TABLE `user` (
  ...
  `phone_number` varchar(15) NOT NULL default '' COMMENT '电话号码',
